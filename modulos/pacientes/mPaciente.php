    ...
    <div class="container form-control p divP" id="factura" >
        <div class="container form-control p" style="background-color:#ADD8E6">
            <div class="input-group">
                <form action="mPaciente.php" method="GET" class="input-group" >
                    <input type="text" class="form-control" name="busqueda" aria-label="Text input with dropdown button">
        ...
        <table class="table table-striped ">
                ...
                $sqldatos;
                if ($nombre == null) {
                    $sqldatos= 'SELECT * FROM practicap.paciente;';
                }else{
                    $sqldatos='SELECT * FROM practicap.paciente where paciente.nombre like"'.$nombre.'%";';
                }
 
                $NPM=$_GET['numero'];
                $NomPM=$_GET['nombre'];
                $DPM=$_GET['direccion'];
                $pruebasql= "update practicap.paciente set nombre='".$NomPM."', direccion='".$DPM."' where NPaciente=".$NPM.";";
                ...
                $PDireccion=$dato['direccion'];

                echo "<tr>";
                    echo '<form action="mPaciente.php" method="GET">';
                    echo '<th scope="row"><input type="text" name="numero" class="form-control" value="'.$Numero.'"></th>';                
                    echo '<th scope="row"><input type="text" name="nombre" class="form-control" value="'.$NPaciente.'"></th>';
                    echo '<th scope="row"><input type="text" name="direccion" class="form-control" value="'.$PDireccion.'"></th>';
