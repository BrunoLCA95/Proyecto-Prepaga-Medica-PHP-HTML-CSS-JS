...
<div class="container form-control p divP" id="factura" >
        <div class="container form-control p" style="background-color:#ADD8E6">
            <div class="input-group">
                <form action="bformSeg.php" method="GET" class="input-group" >
        ...
        <table class="table table-striped ">
                ...
                if ($nombre === null) {
                    $sqlNombre= 'SELECT fs.NFormulario, p.nombre, lc.Nombre FROM formaseguro as fs, paciente as p, listadocompanias as lc where fs.NPaciente=p.NPaciente and fs.Compañia=lc.idCompanias;';
                } else {
                    $sqlNombre= 'SELECT fs.NFormulario, p.nombre, lc.Nombre FROM formaseguro as fs, paciente as p, listadocompanias as lc where fs.NPaciente=p.NPaciente and fs.Compañia=lc.idCompanias and p.nombre like"'.$nombre.'%";';
                }
