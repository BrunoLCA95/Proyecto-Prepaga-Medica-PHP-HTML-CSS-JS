...
$sql_datos='SELECT count(TExamen) as cantidad,tipoExamen as causas from examen,catalogotarifa where TExamen=id group by TExamen;';
...
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Ranking Examenes Medicos',
          height: 500,
          width: '100%'
        };
...
<body>
    ...
    <div class="container form-control p divP" id="ocultarRegN" >
            <div class="container form-control p" style="background-color:#ADD8E6">
                <label for="">Ranking de Examenes medicos mas realizados <label>
            </div>
            <div class="container form-control p" style="background-color:#ADD8E6">
                <div id="piechart"></div>
